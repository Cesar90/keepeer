...
import { NavMain, NavUser } from '@/widgets/Sidebar';
import {
    Sidebar,
    SidebarContent,
    SidebarFooter,
...
const sharedItems = {
    invoices: {
        ...
        items: [
            ...
            {
                title: 'Split Stubs',
                url: '/employees/split-stubs',
            },
            // {
            //     title: 'Employee Create New',
                    ...
                    <SidebarMenuItem>
                        <SidebarMenuButton size="lg" asChild>
                            <a href="/">
                                ...
                                <img
                                    src="https://cermanagementgroup.com/public/assets/images/logos/cer-management-group-logo.svg" // Replace with your actual image path
                                    alt="CER Inc Logo"
                                    // className="size-13"
                                    className="w-15 h-12"
                                />
