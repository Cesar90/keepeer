...
import { Employee, postEmployeeNew } from '@/entities/Employees';
import {
    fetchStates,
    fetchCitiesByState,
    getStatesData,
...
interface IAddNewEmployeeForm {
    getEmployeeData: (employeeData: Employee) => void
}

export function AddNewEmployeeForm(props: IAddNewEmployeeForm) {
